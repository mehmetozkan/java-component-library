...
export class StockpageComponent implements OnInit {
  ...
  countries: string[] = ['TR', 'US', 'UK', 'India', 'UAE'];
  ...
  ngOnInit() {
    ...
    this.registrations.push(new Registration('Mehmet', 'Özkan', {year: 1897, month: 10, day: 27}, 'mehmett.ozkann@gmail.com', 'mehmet123', 'TR'));
    this.registrations.push(new Registration('Bahadır', 'Dırık', {year: 1896, month: 11, day: 5}, 'tariq@gmail.com', 'tariq123', 'UAE'));
    this.registrations.push(new Registration('Serhat', 'Aydın', {year: 1985, month: 10, day: 25}, 'nirmal@gmail.com', 'nirmal123', 'TR'));
  }
